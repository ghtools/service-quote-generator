        ...
        function generateInvoiceNumber() {
            ...
            document.getElementById('invoice_num').value = `${cfg.prefix}-${next}`;
        }
        ...
        function updatePreview() {
            ...
            const showIf = (blockId, cond) => { const e = el(blockId); if (e) e.classList.toggle('hidden', !cond); };
            ...
            if (currentTab === 'request') {
                ...
                setText('prev-to-name', data.cName || 'Valued Customer');
                setText('prev-invoice-type', 'OFFICIAL BILL');
            }
